...
/**
 * Render a layout that provides an animated side drawer and exposes open/close controls via DrawerContext.
 *
 * The component wraps children as the app's main content, displays a backdrop when the drawer is open,
 * and renders an animated left-side drawer containing navigation links and a logout action.
 * Drawer open/close operations are guarded to prevent overlapping animations.
 *
 * @returns {JSX.Element} A React element containing the DrawerContext provider, main content area, backdrop overlay, and the animated drawer panel with navigation and logout. 
 */
